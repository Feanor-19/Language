...
DEF_KEYWORD( AsIngr, "As Ingredients" )
...
DEF_KEYWORD( FuncDefsEnd, "Here Is The Recipe Itself:" )
...
DEF_KEYWORD( PrintStr, "Scream In Despair:" )
...
DEF_KEYWORD( Amp_2, "Unfortunately" )
